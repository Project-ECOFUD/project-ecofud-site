          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-7">
              <div
                className={`${
                  open === "p1"
                    ? "icon-bx-wrapper style-3 left box-hover m-r100 m-b30 wow fadeInRight active"
                    : "icon-bx-wrapper style-3 left box-hover m-r100 m-b30 wow fadeInRight"
                }`}
              ...
              >
                ...
                <div className="wrapper-effect"></div>
              ...
              <div
                className={`${
                  open === "p2"
                    ? "icon-bx-wrapper style-3 left box-hover m-l100 m-b30 wow fadeInRight active"
                    : "icon-bx-wrapper style-3 left box-hover m-l100 m-b30 wow fadeInRight"
                }`}
